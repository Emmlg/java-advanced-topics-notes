...
insert into pedidos (idEmpleado, cvFormPago, idProveedor, folioP, subTotal, IVA, totalPedido, anticipo, fechaPedido, fechaEntrega)
	values
		(1, 'efe', 7, 'Folio-0001', 2000.00, 1500.00, 317.00, 2301.00, '2023-05-10', '2023-06-10'),
        (5, 'efe', 8, 'Folio-0002', 6385.00, 4500.00, 1215.00, 7595.00, '2023-05-11', '2023-06-11');
