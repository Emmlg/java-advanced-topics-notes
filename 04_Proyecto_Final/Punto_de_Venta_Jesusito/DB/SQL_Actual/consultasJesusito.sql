...
-- agregamos los registros a la tabla de pedidos "cam" es por defecto EnCamino
insert into pedidos (idEmpleado, cvFormPago, idProveedor, folioP, subTotal, IVA, totalPedido, anticipo, fechaPedido, fechaEntrega, cvTipoEstado)
	values
		(1, 'efe', 7, 'Folio-0001', 2000.00, 1500.00, 317.00, 2301.00, '2023-05-10', '2023-06-10', "Cam"),
        (5, 'efe', 8, 'Folio-0002', 6385.00, 4500.00, 1215.00, 7595.00, '2023-05-11', '2023-06-11', 'Ret');
...
-- regresamos la fecha de entrega, forma de pago, anticipo y estado
select fechaEntrega, dsFormPago, anticipo, estado from pedidos, cformpago where pedidos.folioP = 'Folio-0002' and cformpago.cvFormPago = pedidos.cvFormPago;
...
-- * consultas faltantes
-- consulta que regresa por defecto los estados de pedido para el comboBox
select cvTipoEstado, dsTipoEstado from cTipoEstado;

-- consulta para actualizas la tabla de pedidos

-- regresamos el id atravez del folio
select idPedido from pedidos where folioP = 'Folio-0001';

-- idEmpleado, cvFormPago, idProveedor, folioP, subTotal, IVA, totalPedido, anticipo, fechaPedido, fechaEntrega, cvTipoEstado
update pedidos set cvFormPago = 'efe', subTotal = 0, iva=0, totalPedido = 0, anticipo = 0, 
fechaEntrega = '2023-07-10', cvTipoEstado = 'Ret' where folioP = "Folio-0001" and idPedido = 1;

-- consulta para actualizas la tabla de detallesPedido
-- idPedido, idProducto, cantProducto, precioC, subTotalPedido
update detallesPedido set cantProducto = 0, precioC = 0, subTotalPedido = 0 where idPedido = 1 and idProducto = '3445343545';